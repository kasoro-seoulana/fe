	...
	if (loading) {
		return (
			<div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-white via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-950">
				<div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-[#5fb3ff] dark:border-[#4a9ce8]"></div>
			</div>
		);
	}
		...
		<div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-950">
			<div className="container mx-auto px-4 py-8">
				<div className="mb-8">
					<Link
						href="/communities"
						className="inline-flex items-center gap-2 text-base font-bold text-[#5fb3ff] dark:text-[#5fb3ff] hover:text-[#4a9ce8] dark:hover:text-[#4a9ce8] bg-white dark:bg-gray-800 px-4 py-2 rounded-full border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] shadow-md transform hover:-translate-x-1 transition-all"
					>
				...
				<div className="flex flex-col lg:flex-row gap-8">
					...
					<div className="flex-1">
						...
						<div className="bg-white dark:bg-gray-800 border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] p-6 mb-8 shadow-xl rounded-xl transform rotate-0">
							{community.imageURL && (
								<div className="mb-6 flex justify-center">
									<img 
										src={community.imageURL} 
										alt={community.name} 
										className="max-h-48 rounded-xl border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] transform hover:scale-105 transition-all duration-300" 
									/>
								</div>
							)}
							...
							<div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-6">
								<div>
									<h1 className="text-4xl font-extrabold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-[#5fb3ff] to-purple-500 dark:from-[#4a9ce8] dark:to-purple-400 uppercase transform rotate-0">{community.name}</h1>
									<p className="text-gray-700 dark:text-gray-300 font-medium text-lg">{community.description}</p>
									<p className="text-base text-[#5fb3ff] dark:text-[#5fb3ff] mt-2 font-bold">
								...
								<div className="flex items-center gap-4">
									{!isExpired() && (
										<button
											...
											className="bg-[#5fb3ff] hover:bg-[#4a9ce8] text-white px-5 py-3 border-4 border-dashed border-white dark:border-gray-700 rounded-full text-base font-extrabold transition-all transform hover:scale-105 shadow-lg uppercase"
										>
											Claim Rewards 💰
										</button>
									)}
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
								<div className="relative overflow-hidden rounded-xl border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] p-5 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 shadow-lg transform rotate-0 hover:rotate-0 transition-all">
									<div className="relative">
										<div className="text-lg font-extrabold mb-1 text-[#5fb3ff] dark:text-[#5fb3ff] uppercase">Total Stonks</div>
										<div className="text-3xl font-mono font-extrabold bg-white dark:bg-gray-900 px-4 py-2 rounded-lg border-2 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] text-center">
								...
								<div className="relative overflow-hidden rounded-xl border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] p-5 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 shadow-lg transform rotate-0 hover:rotate-0 transition-all">
									<div className="relative">
										<div className="text-lg font-extrabold mb-1 text-[#5fb3ff] dark:text-[#5fb3ff] uppercase">Base Fee</div>
										<div className="text-3xl font-mono font-extrabold bg-white dark:bg-gray-900 px-4 py-2 rounded-lg border-2 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] text-center">
							...
							<div className="text-base text-gray-600 dark:text-gray-300 bg-pink-50 dark:bg-pink-900/20 p-4 rounded-xl border-2 border-dashed border-[rgba(255,182,193,0.5)] font-medium">
								{community.contractAddress && (
									<div className="mb-1">
										<span className="font-bold text-[#5fb3ff] dark:text-[#5fb3ff]">Contract:</span> <span className="font-mono">{community.contractAddress}</span>
									</div>
								)}
								<div className="mb-1">
									<span className="font-bold text-[#5fb3ff] dark:text-[#5fb3ff]">Created:</span> {new Date(community.createdAt).toLocaleString()}
								</div>
								<div className="flex items-center">
									<span className="font-bold text-[#5fb3ff] dark:text-[#5fb3ff]">Latest meme:</span>
						...
						<div className="bg-white dark:bg-gray-800 border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] p-6 shadow-xl rounded-xl transform rotate-0">
							<div className="flex items-center gap-4 mb-8">
								<div className="w-8 h-8 bg-[#5fb3ff] rounded-full mr-1 transform rotate-0"></div>
								<h2 className="text-2xl font-extrabold text-[#5fb3ff] dark:text-[#5fb3ff] uppercase">Meme Feed</h2>
								<div className="w-8 h-8 bg-[#5fb3ff] rounded-full ml-1 transform rotate-0"></div>
							</div>
							...
							{isExpired() ? (
								...
								<>
									<div className="mb-8 flex flex-col md:flex-row items-center gap-6">
										<div className="w-40 h-40 bg-gradient-to-br from-pink-100 to-purple-100 dark:from-pink-900 dark:to-purple-900 rounded-xl border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] flex items-center justify-center relative transform hover:scale-105 transition-all">
											<div
												className={`text-4xl font-extrabold ${
													parseInt(remainingTimeText) < 15 ? 'text-red-600 dark:text-red-400 animate-pulse' : 'text-[#5fb3ff] dark:text-[#5fb3ff]'
												}`}
											>
												{remainingTimeText}
											</div>
							...
							<hr className="border-[#5fb3ff] dark:border-[#4a9ce8] border-2 border-dashed mb-6" />
