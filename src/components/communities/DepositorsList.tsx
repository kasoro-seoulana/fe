      ...
      <div className="mb-6 flex flex-col">
        <div className="flex items-center justify-between mb-2">
          ...
          <button 
            ...
            className="text-xs bg-[#5fb3ff] hover:bg-[#4a9ce8] text-white px-2 py-1 rounded-full border-2 border-dashed border-white dark:border-gray-700 transition-all transform hover:scale-110 font-bold"
            title="Refresh list"
          >
            ↻ Refresh
          </button>
        </div>
        <div className="text-sm font-medium text-gray-600 dark:text-gray-400 border-b-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] pb-2">
      ...
      {loading ? (
        <div className="py-2 px-3 text-sm text-gray-500">
          <div className="animate-pulse flex space-x-2 items-center">
            <div className="h-4 w-4 bg-[#5fb3ff]/30 rounded-full"></div>
            <div className="h-4 w-full bg-[#5fb3ff]/20 rounded"></div>
          </div>
        </div>
      ) : error ? (
        ...
        <div className="py-3 px-4 text-sm text-[#5fb3ff] dark:text-[#5fb3ff] italic bg-[#5fb3ff]/10 border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] rounded-xl font-bold text-center">
        ...
        <div className="space-y-3">
          {depositors.map((depositor) => (
            <div 
              key={depositor.id} 
              className="border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] rounded-lg p-3.5 bg-white dark:bg-gray-800 hover:shadow-lg transition-all transform hover:scale-[1.02]"
            >
              <div className="flex-grow">
                <div className="font-extrabold text-[#5fb3ff] dark:text-[#5fb3ff]">
                ...
                >
                  ...
                  <span className="ml-2 bg-[#5fb3ff]/10 dark:bg-[#5fb3ff]/20 px-1.5 py-0.5 rounded text-xs">
